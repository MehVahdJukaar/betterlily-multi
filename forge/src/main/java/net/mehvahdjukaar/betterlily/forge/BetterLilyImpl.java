...
public class BetterLilyImpl {
    ...
    public static final RegistryObject<Block> LILY_BLOCK = BLOCKS.register("water_lily_pad", () -> new WaterloggedLilyBlock(BlockBehaviour.Properties.of(Material.PLANT).instabreak()
